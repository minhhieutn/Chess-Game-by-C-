    ...
    public class Board
    {
        ...
        public bool InsufficientMaterial()
        {
            ...
            return IsKingVKing(counting) || 
                IsKingBishopVKing(counting) || IsKingBishopVKingBishop(counting) || IsKingKnightVKing(counting);
        }
        ...
        private bool IsUnmovedKingAndRook(Position kingPos, Position rookPos)
        {
            ...
            return king.Type == PieceType.King && rook.Type == PieceType.Rook && !king.HasMove && !rook.HasMove;
        }
